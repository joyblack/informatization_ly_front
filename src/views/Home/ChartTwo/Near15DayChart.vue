...
<script>
    ...
    const dataUrl = {
        getNear15Day: '/api/statistic-output/getNear15Day',//获取最近15日产煤趋势
    };
        ...
        methods: {
            ...
            initChart() {
                ...
                var chart = new G2.Chart({
                    container: 'Near15DayChart',
                    forceFit: true,
                    height: 350
                });
                chart.source(dv);
                chart.intervalStack().position('month*value').color('name');
                chart.legend({
                    position: 'top-center'
                });
                chart.render();
